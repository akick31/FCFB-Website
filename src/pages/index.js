...
export { Admin, UserManagement, GameManagement, TeamManagement, EditTeam, EditCoach, CoachManagement, CoachTransactionLog,
    EditGame, StatsManagement, Reports, Scheduling, GameWeek, RankingsManagement } from './admin';
